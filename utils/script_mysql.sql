...
-- feedbacks positivos
UPDATE TB_FEEDBACK SET I_SENT_FEEDBACK = 1 WHERE S_AUTOR_FEEDBACK = 'Joana Silva';
UPDATE TB_FEEDBACK SET I_SENT_FEEDBACK = 1 WHERE S_AUTOR_FEEDBACK = 'Isadora Almeida';
UPDATE TB_FEEDBACK SET I_SENT_FEEDBACK = 1 WHERE S_AUTOR_FEEDBACK = 'Júlia César';
UPDATE TB_FEEDBACK SET I_SENT_FEEDBACK = 1 WHERE S_AUTOR_FEEDBACK = 'Letícia Moreira';
UPDATE TB_FEEDBACK SET I_SENT_FEEDBACK = 1 WHERE S_AUTOR_FEEDBACK = 'Márcia Dias';
UPDATE TB_FEEDBACK SET I_SENT_FEEDBACK = 1 WHERE S_AUTOR_FEEDBACK = 'Nina Castro';
UPDATE TB_FEEDBACK SET I_SENT_FEEDBACK = 1 WHERE S_AUTOR_FEEDBACK = 'Ofélia Ramos';
UPDATE TB_FEEDBACK SET I_SENT_FEEDBACK = 1 WHERE S_AUTOR_FEEDBACK = 'Paula Vitoria';
UPDATE TB_FEEDBACK SET I_SENT_FEEDBACK = 1 WHERE S_AUTOR_FEEDBACK = 'Quésia Monteiro';
UPDATE TB_FEEDBACK SET I_SENT_FEEDBACK = 1 WHERE S_AUTOR_FEEDBACK = 'Renata Lima' AND I_COD_CAMPANHA = 1;
UPDATE TB_FEEDBACK SET I_SENT_FEEDBACK = 1 WHERE S_AUTOR_FEEDBACK = 'Renata Lima' AND I_COD_CAMPANHA = 2;

-- feedbacks negativos
UPDATE TB_FEEDBACK SET I_SENT_FEEDBACK = 0 WHERE S_AUTOR_FEEDBACK = 'Ana Paula';
UPDATE TB_FEEDBACK SET I_SENT_FEEDBACK = 0 WHERE S_AUTOR_FEEDBACK = 'Ingrid Silva' AND I_COD_CAMPANHA = 1;
UPDATE TB_FEEDBACK SET I_SENT_FEEDBACK = 0 WHERE S_AUTOR_FEEDBACK = 'Carla Eduarda' AND I_COD_CAMPANHA = 1;
UPDATE TB_FEEDBACK SET I_SENT_FEEDBACK = 0 WHERE S_AUTOR_FEEDBACK = 'Daniela Moura';
UPDATE TB_FEEDBACK SET I_SENT_FEEDBACK = 0 WHERE S_AUTOR_FEEDBACK = 'Eduarda Lima';
UPDATE TB_FEEDBACK SET I_SENT_FEEDBACK = 0 WHERE S_AUTOR_FEEDBACK = 'Fernanda Torres';
UPDATE TB_FEEDBACK SET I_SENT_FEEDBACK = 0 WHERE S_AUTOR_FEEDBACK = 'Gabriela Souza';
UPDATE TB_FEEDBACK SET I_SENT_FEEDBACK = 0 WHERE S_AUTOR_FEEDBACK = 'Helena Rocha';
UPDATE TB_FEEDBACK SET I_SENT_FEEDBACK = 0 WHERE S_AUTOR_FEEDBACK = 'Maria Mendes';
UPDATE TB_FEEDBACK SET I_SENT_FEEDBACK = 0 WHERE S_AUTOR_FEEDBACK = 'Joana Prado';
UPDATE TB_FEEDBACK SET I_SENT_FEEDBACK = 0 WHERE S_AUTOR_FEEDBACK = 'Karina Dias';
UPDATE TB_FEEDBACK SET I_SENT_FEEDBACK = 0 WHERE S_AUTOR_FEEDBACK = 'Lúcia Oliveira';
UPDATE TB_FEEDBACK SET I_SENT_FEEDBACK = 0 WHERE S_AUTOR_FEEDBACK = 'Mariana Alves';
UPDATE TB_FEEDBACK SET I_SENT_FEEDBACK = 0 WHERE S_AUTOR_FEEDBACK = 'Natália Ribeiro';
UPDATE TB_FEEDBACK SET I_SENT_FEEDBACK = 0 WHERE S_AUTOR_FEEDBACK = 'Otaviana Nunes';
UPDATE TB_FEEDBACK SET I_SENT_FEEDBACK = 0 WHERE S_AUTOR_FEEDBACK = 'Patrícia Gomes';
UPDATE TB_FEEDBACK SET I_SENT_FEEDBACK = 0 WHERE S_AUTOR_FEEDBACK = 'Rafaela Costa';
UPDATE TB_FEEDBACK SET I_SENT_FEEDBACK = 0 WHERE S_AUTOR_FEEDBACK = 'Sabrina Martins';
UPDATE TB_FEEDBACK SET I_SENT_FEEDBACK = 0 WHERE S_AUTOR_FEEDBACK = 'Tamara Lima';
UPDATE TB_FEEDBACK SET I_SENT_FEEDBACK = 0 WHERE S_AUTOR_FEEDBACK = 'Vanessa Cruz';
UPDATE TB_FEEDBACK SET I_SENT_FEEDBACK = 0 WHERE S_AUTOR_FEEDBACK = 'Ingrid Silva' AND I_COD_CAMPANHA = 2;
UPDATE TB_FEEDBACK SET I_SENT_FEEDBACK = 0 WHERE S_AUTOR_FEEDBACK = 'Carla Eduarda' AND I_COD_CAMPANHA = 2;

-- feedbacks neutros
UPDATE TB_FEEDBACK SET I_SENT_FEEDBACK = 2 WHERE S_AUTOR_FEEDBACK = 'Diega Rocha';
UPDATE TB_FEEDBACK SET I_SENT_FEEDBACK = 2 WHERE S_AUTOR_FEEDBACK = 'Ximena Borges';
UPDATE TB_FEEDBACK SET I_SENT_FEEDBACK = 2 WHERE S_AUTOR_FEEDBACK = 'Jessica Ferreira';
UPDATE TB_FEEDBACK SET I_SENT_FEEDBACK = 2 WHERE S_AUTOR_FEEDBACK = 'Zuleika Matos';
UPDATE TB_FEEDBACK SET I_SENT_FEEDBACK = 2 WHERE S_AUTOR_FEEDBACK = 'Bárbara Lins';
UPDATE TB_FEEDBACK SET I_SENT_FEEDBACK = 2 WHERE S_AUTOR_FEEDBACK = 'Carolina Martins';
UPDATE TB_FEEDBACK SET I_SENT_FEEDBACK = 2 WHERE S_AUTOR_FEEDBACK = 'Debora Sena' AND I_COD_CAMPANHA = 1;
UPDATE TB_FEEDBACK SET I_SENT_FEEDBACK = 2 WHERE S_AUTOR_FEEDBACK = 'Eliza Carvalho';
UPDATE TB_FEEDBACK SET I_SENT_FEEDBACK = 2 WHERE S_AUTOR_FEEDBACK = 'Fábia Lopes';
UPDATE TB_FEEDBACK SET I_SENT_FEEDBACK = 2 WHERE S_AUTOR_FEEDBACK = 'Ana Maria Henrique';
UPDATE TB_FEEDBACK SET I_SENT_FEEDBACK = 2 WHERE S_AUTOR_FEEDBACK = 'Debora Sena' AND I_COD_CAMPANHA = 2;
